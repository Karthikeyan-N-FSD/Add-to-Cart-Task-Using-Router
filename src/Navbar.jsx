...
export function Navbar(props) {
    ...
    return (
        <nav className="bg-gray-800 text-white px-7 fixed w-full flex justify-between items-center">
            <Link to={"/"} className="flex items-center gap-1">
                <img className="w-13 rounded-full" src="/logo.webp"></img>
                <p className="text-white font-semibold text-xl">KAZ Store</p>
            </Link>
            <p>(Indivigual Product card route to Product Full page via Param)</p>
